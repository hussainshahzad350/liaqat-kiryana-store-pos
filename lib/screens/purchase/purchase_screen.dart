...
class _PurchaseScreenState extends State<PurchaseScreen> {
  ...
  double get _totalAmount => _cartItems.fold(0, (sum, item) => sum + (item['total_amount'] as int));
  ...
  void _addItem() async {
    ...
    final products = await _itemsRepo.getAllProducts(); // Should use a search optimized method in real app
    if (!mounted) return;
          ...
          child: Column(
            ...
            children: [
              ...
              TextField(
                ...
                decoration: const InputDecoration(labelText: 'Buy Price (Unit)', border: OutlineInputBorder(), prefixText: 'Rs '),
              ),
              const SizedBox(height: 12),
              TextField(
              ...
              TextField(
                ...
                decoration: const InputDecoration(labelText: 'Expiry Date (YYYY-MM-DD)', border: OutlineInputBorder(), hintText: '2025-12-31'),
                onTap: () async {
  ...
  void _savePurchase() async {
    ...
    final purchaseData = {
      ...
      'invoice_number': _invoiceCtrl.text.isEmpty ? 'PUR-${DateTime.now().millisecondsSinceEpoch}' : _invoiceCtrl.text,
                    ...
                    Expanded(
                      child: InkWell(
                        ...
                        child: InputDecorator(
                          ...
                          child: Text(
                            _selectedSupplier?['name_english'] ?? 'Select Supplier',
                            style: TextStyle(
                              color: _selectedSupplier == null ? Colors.grey : colorScheme.onSurface,
                            ),
                          ),
                        ),
                      ),
